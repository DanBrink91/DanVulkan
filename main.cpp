...
private:
    ...
    void drawFrame()
    {
        ...
        // Check if a previous frame is uinsg this image
    ...
    {
        // Allocate a temp command buffer to copy data between buffers
        VkCommandBufferAllocateInfo allocInfo = { VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO };
        allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
        allocInfo.commandPool = commandPool;
        ...
        vkEndCommandBuffer(commandBuffer); // stop recording
